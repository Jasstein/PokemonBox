...
public record CreatePokemonRequestDto(
        @NotBlank(message = ERROR_MESSAGE_SPECIES_LENGTH)
        @Length(max = 12, message = ERROR_MESSAGE_SPECIES_LENGTH)
        String species,
    ...
    private static final String ERROR_MESSAGE_SPECIES_LENGTH =
            "Species length must be between 1 and 12 characters.";
    ...
    private static final String ERROR_MESSAGE_GENDER =
            "Pokemon gender must be provided.";
